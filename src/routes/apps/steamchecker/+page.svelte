<div class="wrapper">
	...
	<p>
		...
		you own it or not, there is no way of determining if a bundle you're about to get on
		HumbleBundle.com has games in your Steam library. Although it may be cheap, spending money on a
		10-game bundle where you already owned 9 of the games always makes me frustrated, so I created
		this extension! This will gray-out any game you own on Steam that is on any of the weekly
	...
	<p>
		...
		or profile name can be found in your profile URL "steamcommunity.com/id/XXXXXXXXXX/" or
		"steamcommunity.com/profiles/XXXXXXXXXXXXXXXXXX/"
	</p>
	<p>
		Note: Humble Bundle uses a different naming format than Steam does for some games, but I will
		try to keep the alias file as up to date as possible whenever new bundles come out or new games
		are added to a bundle. If you see that games aren't showing up in a bundle, don't hesitate to
		contact me!
	</p>
	<h2>Download</h2>
	<p>
		<a
			href="https://chrome.google.com/webstore/detail/steam-library-checker/eopegaefgepfdedhecfbclehhffiebpk"
	...
	<div class="minimizeBlock" id="miniVersion">
		...
		<ul>
			...
			<li>
				Alias file - Alias file now delivered with server, so no longer have to update extension to
				get newest names
			</li>
		</ul>
		<h3>Version 0.1</h3>
